      ...
      <nav className='menuWrapp'>
          <ul className='menuWrapp__list'>
            <li className='menuWrapp__item'>
             <span>Overview <ArrowDropDownRoundedIcon/></span>
            ...
            <li className='menuWrapp__item'>
             <span>Media <ArrowDropDownRoundedIcon/></span>
             <div className='menuWrapp__drop'>
            ...
            <li className='menuWrapp__item'>
             <span>Fandom <ArrowDropDownRoundedIcon/></span>
             <div className='menuWrapp__drop'>
            ...
            <li className='menuWrapp__item'>
             <span>Share <ArrowDropDownRoundedIcon/></span>
             <div className='menuWrapp__drop'>
